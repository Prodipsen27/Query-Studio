  ...
  return (
    <div className="max-w-4xl space-y-10 animate-fade-in pb-20">
      ...
      >
        <SettingsField label="Full Name" icon={User}>
          <input 
            ...
            className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:border-indigo-500/50 transition-all font-medium"
          />
        </SettingsField>
      ...
      >
        <SettingsField label="GitHub Token" icon={Lock}>
          <input 
            type="password" 
            defaultValue="********************************" 
            className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-indigo-400 outline-none focus:border-indigo-500/50 transition-all font-mono"
          />
        </SettingsField>
        <SettingsField label="Model Version" icon={RefreshCw}>
          <select className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:border-indigo-500/50 transition-all font-medium appearance-none">
      ...
      >
        <SettingsField label="Studio Theme" icon={Monitor}>
          <div className="flex gap-2">
             <button className="flex-1 py-2 bg-indigo-500/20 border border-indigo-500/40 text-indigo-400 rounded-xl text-[10px] font-bold uppercase tracking-widest">Midnight</button>
             <button className="flex-1 py-2 bg-white/5 border border-white/5 text-slate-500 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:text-white transition-all">Oceanic</button>
             <button className="flex-1 py-2 bg-white/5 border border-white/5 text-slate-500 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:text-white transition-all">Deep Space</button>
          </div>
        </SettingsField>
      ...
      <div className="p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-emerald-500/60 font-bold uppercase tracking-[0.15em]">Supabase AWS-1-ap-south-1 Node</p>
          </div>
        </div>
        <button className="px-6 py-2.5 bg-[#0a0f1c] hover:bg-white/5 text-xs font-bold text-white rounded-xl border border-white/10 transition-all">
          Connection Test
        </button>
      </div>
      ...
      <div className="flex justify-end pt-4">
        <button 
          onClick={handleSave}
          className="flex items-center gap-2 px-8 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-2xl font-bold transition-all shadow-lg shadow-indigo-600/20 hover:scale-[1.02] active:scale-[0.98]"
        >
          {isSaving ? (
            <>
